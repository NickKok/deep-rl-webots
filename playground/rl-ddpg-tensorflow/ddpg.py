        ...
        for j in range(int(args['max_episode_len'])):
            ...
            if replay_buffer.size() > int(args['minibatch_size']):
                s_batch, a_batch, r_batch, t_batch, s2_batch = \
                    replay_buffer.sample_batch_terminals(int(args['minibatch_size']))
            ...
            if terminal:
                if j == 0:
                    print "Very weird, this episode has a length of 0, we don't want to compute any shit just skip"
                    import ipdb; ipdb.set_trace()
                else:
