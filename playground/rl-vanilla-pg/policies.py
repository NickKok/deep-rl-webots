...
class DisceretePolicy(object):
    ...
    def __init__(self, sess, ob_dim, ac_dim):
        ...
        self.sampled_ac = tf.nn.sigmoid(utils.categorical_sample_logits(self.logits_na)[0])
...
class GaussianPolicy(object):
    ...
    def __init__(self, sess, ob_dim, ac_dim):
        ...
        self.sampled_ac = tf.nn.sigmoid((tf.random_normal(tf.shape(self.mean_na)) * tf.exp(self.logstd_a) + self.mean_na)[0])
